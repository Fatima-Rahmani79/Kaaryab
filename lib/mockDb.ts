...
// جدول توی Supabase از snake_case استفاده می‌کنه (استاندارد Postgres)،
// ولی بقیهٔ اپ ما camelCase می‌خواد (applyLink, createdAt) — این دو تابع
// تبدیل بین این دو شکل رو انجام می‌دن، تا فقط همین یک فایل نگران این تفاوت باشه.
