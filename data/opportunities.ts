...
export const opportunities: Opportunity[] = [
  ...
  },
  {
    ...
    organization: "AsiaConnect BPO",
    category: "Remote Work",
    location: "Online",
    type: "Remote",
    deadline: "2026-07-15",
    description:
      "Handle customer inquiries via chat and email for an international company.",
    requirements: ["Fluent English", "Good internet", "Laptop"],
    applyLink: "https://example.com/support-job",
    tags: ["Remote", "Customer Support"],
